...
Examples target the official Kujo 1.5.0 release, verified on 2026-09-23. Known differences between its VM and written contracts are documented in the [evidence ledger](/evidence/). Experimental JIT and deferred generics, FFI, WASM, and macros are not baseline course features.
